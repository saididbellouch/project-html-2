...
document.getElementById('video-button').addEventListener('click', function (event) {
    ...
    const videoLink = `file:///${encodeURIComponent(videoFile)}`;
    ...
    if (isChromium) {
        ...
        source.type = 'C:/Users/saidi/OneDrive/Desktop/project2 html/resume-builder/assets/video/Professional Resume Builder.mp4';
